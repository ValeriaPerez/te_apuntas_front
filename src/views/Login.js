        ...
        <div className='login__icons'>
          <SocialLogin
            ...
            <Button className='SocialMediaEvent' variant='outlined' color='primary'>
              <img className='login__icons__icon' src={ require('../assets/images/fb.png')} alt='icono'/>
            </Button>
          </SocialLogin>
          <div>
            <InstagramLogin
              ...
              <img className='login__icons__icon' src={ require('../assets/images/instagram.png')} alt='icono'/>
             </InstagramLogin>
          </div>
          <div>
            <LinkedIn
             ...
             text={<img className='login__icons__icon' src={ require('../assets/images/linkedin.png') } alt='icono'/>}>
            </LinkedIn>
          </div>
